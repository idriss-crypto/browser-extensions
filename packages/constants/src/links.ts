...
export const BRAND_GUIDELINE_LINK = 'https://docs.idriss.xyz/resources/brand-guidelines'
...
export const CREATORS_DOCS_LINK = 'https://docs.idriss.xyz/user-guides/creators'
