    ...
    return (
      <label className={classes('flex items-center', wrapperClassName)}>
        <RadixCheckbox.Root
          ...
          title={title}
          className={classes(
            'flex size-[22px] appearance-none items-center justify-center rounded-[4px] bg-[#F3F4F6] shadow-[0_0_0_1px_black] outline-none hover:bg-[#E5E7EB] focus:shadow-[0_0_0_1px_gray]',
