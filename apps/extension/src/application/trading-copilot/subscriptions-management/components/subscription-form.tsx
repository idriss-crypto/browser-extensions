        ...
        render={({ field }) => {
          return (
            <input
              ...
              type="text"
              id="subscriptionName"
              className="border-gray-300 mt-1 block w-full rounded-md border bg-white px-3 py-2 text-black shadow-sm focus:border-[#3b82f6] focus:outline-none focus:ring-[#3b82f6] sm:text-sm"
