...
export const Proposal = ({
  ...
  return (
    <WidgetBase
      className={classes(
        'text-tally-text-primary bg-white text-xs leading-tight',
        className,
      )}
      onClose={onClose}
    >
      ...
      <header className="flex items-center justify-between space-x-3">
        <p className="text-tally-gray-500 line-clamp-[1] break-all text-xs leading-5 hover:underline">
          By{' '}
          <a
      ...
      <footer className="mt-3.5 flex items-center justify-between">
        <div className="flex justify-start gap-1.5">
          <div className="text-tally-gray-500 flex min-w-[84px] items-center text-xs leading-5">
          ...
          >
            <Chip
              className="border-tally-gray-700 bg-tally-gray-700 hover:bg-tally-gray-900 mr-2 inline-flex select-none items-center justify-center rounded-md border px-4 py-1 font-semibold text-white transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
              variant="info"
              width="long"
            >
              Vote
