  ...
  return (
    <div className={classes('relative flex size-full bg-mint-100', className)}>
      <div
        ...
        style={style}
      >
        <div className="container flex flex-col gap-10 p-0 lg:gap-[104px] lg:[@media(min-height:1001px)]:[@media(max-height:1100px)]:gap-[50px] lg:[@media(max-height:1000px)]:gap-[30px] lg:[@media(max-height:770px)]:gap-[24px]">
          <div className="flex flex-col items-start gap-[64px] lg:[@media(max-height:1100px)]:gap-[50px] lg:[@media(max-height:770px)]:gap-[24px]">
            ...
            <Image
              ...
              alt=""
              className="bottom-0 right-0 top-1/2 lg:absolute lg:max-w-[45%] lg:-translate-y-1/2 [@media(min-width:1001px)]:[@media(min-height:901px)]:[@media(max-height:1100px)]:translate-y-[-40%] lg:[@media(max-width:1440px)]:[@media(max-height:1000px)]:translate-y-[-30%] lg:[@media(min-height:1300px)]:-translate-y-full"
            />
          </div>
          <div className="overflow-hidden">
            <div
