...
export const ProductSection = ({
  ...
  return (
    <div className={classes('relative flex size-full bg-mint-100', className)}>
      <div
        className="flex size-full flex-col bg-[linear-gradient(115deg,_#022B1E_34.81%,_#079165_123.57%)] px-4 transition-[border-radius] duration-150 will-change-[border-radius] lg:px-[120px] lg:pt-[80px] lg:[@media(max-height:1100px)]:pt-[30px]"
        style={style}
      >
