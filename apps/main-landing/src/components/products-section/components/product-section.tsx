          ...
          <div className="flex flex-col items-start gap-[64px] lg:[@media(max-height:1100px)]:gap-[50px]">
            ...
            <div className="z-1 flex flex-col gap-4">
              <div className="z-1 overflow-hidden">
                <h2
                  className={classes(
                    'text-balance pt-8 text-display5 text-midnightGreen-100 transition-transform duration-1000 [@media(max-width:1440px)]:[@media(max-height:1000px)]:text-display4 [@media(min-width:1441px)]:text-display2',
                    headerClassName,
