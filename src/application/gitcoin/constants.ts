...
export const WRAPPED_ETH_ADDRESS_PER_CHAIN_ID: Record<number, Hex> = {
...
export const DONATION_CONTRACT_ADDRESS_PER_CHAIN_ID: Record<number, Hex> = {
...
export const GITCOIN_DONATION_CHAINS_IDS = Object.keys(
