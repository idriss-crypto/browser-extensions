...
export class AbstractPageManager {
    ...
    isEnabled() {
        return new Promise(r => chrome.storage.local.get(['block-explorers-enabled', 'entire-extension-enabled'], x => r((x?.['entire-extension-enabled'] && x?.['block-explorers-enabled']) ?? true)))
    }
